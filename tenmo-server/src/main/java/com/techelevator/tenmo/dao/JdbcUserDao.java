...
import com.techelevator.tenmo.exceptions.UserExceptions.EmptyUsernameException;
...
public class JdbcUserDao implements UserDao {
    ...
    private static final String GET_findByUsername_SQL = "SELECT user_id, username, password_hash FROM tenmo_user WHERE username = ?";
    ...
    public User findByUsername(String username) {
        ...
        try{
            ...
            result = jdbcTemplate.queryForRowSet(GET_findByUsername_SQL, username);
        }catch(NullUsernameException e){
            System.out.println(e.getMessage());
        }catch (NullPointerException | EmptyResultDataAccessException e) {
            throw new UsernameNotFoundException("User " + username + " was not found.");
